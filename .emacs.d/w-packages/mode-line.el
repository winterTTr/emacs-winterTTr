...
(defun w/mode-line:current-height ()
...
(defun w/defun-bicolor-face (face fg-color bg-color)
    (make-face face)
    (set-face-attribute face nil
                        :foreground fg-color
                        :background bg-color))

(defun w/defun-bicolor-transition-face (face bicolor-face-from bicolor-face-to)
  (w/defun-bicolor-face face
                           (face-attribute bicolor-face-from :background)
                           (face-attribute bicolor-face-to :background)))
  
    

(defun w/bicolor-face-attribute (face)
  (list
   (face-attribute face :foreground)
   (face-attribute face :background)))

(defun w/mode-line:data-generator-left-triangle (height width)
...
(defun w/mode-line:data-generator-eight-trigrams (height width)
  (list "..............      "
        "............        "
        ".........           "
        ".......             "
...
(defun w/create-bicolor-xpm (height width fg-color bg-color data-generator)
...
(defun w/create-bicolor-xpm-from-face (height width bicolor-face data-generator)
  (apply #'w/create-bicolor-xpm
         (append 
          (list height width)
          (w/bicolor-face-attribute bicolor-face)
          (list data-generator))))


(defun w/mode-line:create-left-triangle-xpm (bicolor-face &optional width)
...
and BG-COLOR to be the background color"
  (let* ((height (w/mode-line:current-height))
         (width (or width height)))
    (w/create-bicolor-xpm-from-face height
                                       width
                                       bicolor-face
                                       #'w/mode-line:data-generator-left-triangle)))

(defun w/mode-line:create-eight-trigrams-xpm (bicolor-face)
  (let ((height (w/mode-line:current-height)))
    (w/create-bicolor-xpm-from-face height
                                       height
                                       bicolor-face
                                       #'w/mode-line:data-generator-eight-trigrams)))


(defun w/mode-line:decorate-string-face (mode-line-var bicolor-face)
...
(w/defun-bicolor-face 'mode-line-face/encoding-writable-modified "#000000" "#999999")
(w/defun-bicolor-face 'mode-line-face/buffer-name "#FFFFFF" "#555555")
(w/defun-bicolor-transition-face 'mode-line-face/transition1
                                    'mode-line-face/encoding-writable-modified
                                    'mode-line-face/buffer-name)
(w/defun-bicolor-transition-face 'mode-line-face/transition2
                                    'mode-line-face/buffer-name
                                    'mode-line)

(defun w/mode-line:create-triangle-seperator (face)
  (propertize " "
              'display
              (w/mode-line:create-left-triangle-xpm face)))

(defun w/mode-line:create-eight-trigrams-seperator (face)
  (propertize " "
              'display
...
(setq-default mode-line-format
              (list
               ...
               (w/mode-line:decorate-string-face mode-line-modified
                                                    'mode-line-face/encoding-writable-modified)
               (w/mode-line:create-eight-trigrams-seperator 'mode-line-face/transition1)
               ;mode-line-remote, remove
               ;mode-line-frame-identification, remove
               (w/mode-line:decorate-string-face mode-line-buffer-identification
                                                    'mode-line-face/buffer-name)
               (w/mode-line:create-triangle-seperator 'mode-line-face/transition2)
               mode-line-position
...
;(insert (w/mode-line:create-triangle-seperator 'mode-line-face/transition1))
;(w/create-bicolor-xpm 20 10 "#0A0A0A" "#A0A0A0" #'w/mode-line:data-generator-left-triangle)
;(w/create-bicolor-xpm-from-face 20 10 'mode-line-face/transition1
;                                   'w/mode-line:data-generator-left-triangle)
